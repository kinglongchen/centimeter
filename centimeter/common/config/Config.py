...
class Config(object):
    ...
    lopEmailTextFilePath = os.sep.join([PathUtil.getEmailResourcePath(), "lopEmailText.txt"])
    defaultEmailTextFilePath = os.sep.join([PathUtil.getEmailResourcePath(),"defaultEmailText.txt"])
    noReportEmailTextFilePath = os.sep.join((PathUtil.getEmailResourcePath(),"noReportEmailText.txt"))
    lopToAddrMap = {}
    kingDeeToAddrMap = {}
    emailPassword = ""
    fromAddrMap = {}
